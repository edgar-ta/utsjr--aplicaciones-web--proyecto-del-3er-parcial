...
/**
 * 
 * @param {import("../bd/database-controller").MidwayColumnType} dataType 
 * @returns {import("../bd/database-controller").ExternalColumnType}
 */
function coalesceSqlToColumnType(dataType) {
    switch (dataType) {
